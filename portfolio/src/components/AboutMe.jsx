    ...
    return (
        <div className={styles.aboutMe} id="about-me">
         ...
         <div className={styles.aboutMe_text}>
            ...
            <h1 className={styles.name}>Prasaanth</h1>
            <h3 className={styles.developer}>An Aspiring Developer</h3>
            <p>Driven and freshly graduated from a rigorous coding bootcamp, I am a software developer eager to embark on my professional journey in this industry. 
